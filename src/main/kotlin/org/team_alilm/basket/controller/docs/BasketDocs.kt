...
interface BasketDocs {
    ...
    ): org.team_alilm.common.response.ApiResponse<MyBasketProductListResponse>
    ...
    fun copyBasket(
        @Parameter(hidden = true) customMemberDetails: CustomMemberDetails,
        productId: Long
    ): org.team_alilm.common.response.ApiResponse<Unit>
    ...
    fun deleteBasket(@Parameter(hidden = true) customMemberDetails: CustomMemberDetails, basketId: Long): org.team_alilm.common.response.ApiResponse<Unit>
}