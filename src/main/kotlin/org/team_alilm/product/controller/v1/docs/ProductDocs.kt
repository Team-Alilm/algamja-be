...
interface ProductDocs {
    ...
    ): org.team_alilm.common.response.ApiResponse<ProductCountResponse>
    ...
    fun getProductDetail(productId: Long): org.team_alilm.common.response.ApiResponse<ProductDetailResponse>
    ...
    fun getProductList(param : ProductListParam): org.team_alilm.common.response.ApiResponse<ProductListResponse>
    ...
    fun getSimilarProducts(productId: Long): org.team_alilm.common.response.ApiResponse<SimilarProductListResponse>
    ...
    fun getRecentlyRestockedProducts(): org.team_alilm.common.response.ApiResponse<RecentlyRestockedProductListResponse>
    ...
    fun crawlProduct(productUrl: kotlin.String): org.team_alilm.common.response.ApiResponse<CrawlProductResponse>
}