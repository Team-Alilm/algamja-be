package org.team_alilm.algamja.notification.controller.docs
...
interface NotificationDocs {
    ...
    ): CommonApiResponse<UnreadNotificationCountResponse>
    ...
    fun getRecentNotifications(
        @Parameter(hidden = true) customMemberDetails: CustomMemberDetails
    ): CommonApiResponse<RecentNotificationResponseList>
